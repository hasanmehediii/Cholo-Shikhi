...
export default function HomePage() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen text-center p-4 sm:p-8 bg-gray-50">
      <div className="max-w-3xl">
        ...
        <div className="mt-10">
          <Link
            href="/dashboard"
            className="px-8 sm:px-10 py-3 sm:py-4 text-base sm:text-lg font-bold text-white bg-blue-600 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 transform hover:scale-105"
          >
            Launch Explorer
          </Link>
        </div>
